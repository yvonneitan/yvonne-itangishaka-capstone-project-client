...
const handleConfirmDelete = async () => {
  ...
  try {
    const response = await fetch(`http://localhost:8080/api/lists/task-lists/${idToDelete}`, {
      method: 'DELETE',
    });
  ...
  const handleDeleteList = async (listId) => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/lists/task-lists/${listId}`, {
        method: "DELETE",
      });
  ...
  const handleUpdateList = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/lists/task-lists/${editingListId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
                ...
                {editingListId === list.id ? (
                  ...
                  <>
                    ...
                    <span className="sidebar__lists--count">{list.count || 0}</span>
                     <button onClick={() => handleOpenDeleteModal(list.id)} className="main-content__task--delete-button">
                  <img src={deleteIcon} alt="edit icon" className="main-content__task--edit-icon"/>
                  </button>
                  <button onClick={() => handleEditList(list)} className="main-content__task--edit-button">
          ...
          <div className="create__box">
            <div className="sidebar__create">
              ...
              <div className="sidebar__create--buttons">
                <button className="sidebar__create--list-add-btn" onClick={handleCreateNewList}>
                  Add List
                </button>
                <button
                  type="button"
